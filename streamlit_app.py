...
def main():
    ...
    with st.sidebar:
        ...
        Uses Directors, Officers, and IRS Contact people connected to Organizations, as listed on IRS documents.
        ...
        Minimize Sidebar
        - Hover over side bar
        - Use **<** and  **>** at top of sidebar to collapse and expand
        
        Double-click on a Node to connections
    ...
    if which_graph == 'Orgs to People':            
        ...
        test_graph(all_people_df, charge, width, height)
